...
//Write scraped recipes to the excel
public class RecipeWriter {
    ...
    public void writeRecipes(String recipeId, String recipeName, String recipeCategory,
        ...
        String cookingTime, String preparationMethod, String nutrientValue, String morbidity, String recipeURL, String haveToAdd, String allergicIngredient) throws IOException {
        ...
        row.createCell(12).setCellValue(allergicIngredient);
    }
